...
internal sealed class FireSpin : Card, IDemoCard
{
    ...
    {
        helper.Content.Cards.RegisterCard("FireSpin", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "FireSpin", "name"]).Localize
        });
    }
